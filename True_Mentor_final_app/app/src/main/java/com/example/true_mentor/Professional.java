...
public class Professional extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("Professional").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Professional.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                loadingDialog.dismiss();
                finish();
            }
        });
