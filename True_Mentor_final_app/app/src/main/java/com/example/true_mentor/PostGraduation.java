...
public class PostGraduation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("PostGraduation").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(PostGraduation.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                loadingDialog.dismiss();
                finish();
            }
        });
